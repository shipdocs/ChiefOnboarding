        ...
        successMessage.innerHTML = `
          <div class="onboarding-content-section">
            <div style="text-align: center;">
              ...
              <p>Bedankt voor het voltooien van de admin onboarding. U kunt nu beginnen met het gebruik van ShipDocs Maritime Onboarding om geweldige onboarding ervaringen te creëren voor uw nieuwe medewerkers.</p>
            </div>
          </div>
        `;
