...
class AdminOnboardingContentView(LoginRequiredMixin, AdminPermMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            # Add welcome step
            items.append({
                'title': _('Welkom bij ShipDocs Maritime Onboarding'),
                'content': _('''
                <div class="onboarding-content-section">
                    <h3>Welkom bij uw nieuwe onboarding platform!</h3>

                    <p>Fijn dat u heeft gekozen voor ShipDocs Maritime Onboarding. Deze interactieve gids helpt u om snel vertrouwd te raken met het systeem, zodat u direct aan de slag kunt met het creëren van geweldige onboarding ervaringen voor uw nieuwe medewerkers.</p>
                    ...
                    <p>Klik op "Volgende" om te beginnen met uw reis door ShipDocs Maritime Onboarding!</p>
                </div>
                ''')
            })
            ...
            items.append({
                ...
                <div class="onboarding-content-section">
                    <div class="onboarding-success">
                        ...
                        <p>U bent nu klaar om ShipDocs Maritime Onboarding volledig te gaan gebruiken en geweldige onboarding ervaringen te creëren voor uw nieuwe medewerkers.</p>
